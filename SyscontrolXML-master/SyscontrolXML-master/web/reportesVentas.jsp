...
<%
    ...
    if (codigo == 1) {
        File reporFile = new File(application.getRealPath("/ReportesVentas/vTimbrados.jasper"));
        Map parameters = new HashMap();
        parameters.put("idtimbrado", Integer.parseInt(request.getParameter("idtimbrado")));
