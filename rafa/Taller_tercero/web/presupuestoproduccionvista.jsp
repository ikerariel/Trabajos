<%-- 
    Document   : presupuestoproduccionvista
    Created on : 01/08/2019, 09:01:29 AM
    Author     : Rafel
--%>
            ...
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesPresupuestoCompra">
                    <a id="btnNuevo" href="#ventanaPresupuestoCompra" class="btn btn-lg btn-success" style=" font-weight: bold"  title="Nuevo Factura Compras" data-toggle="modal"
                       onclick="getcodigoPresuComp(); fechaactualPresuCompra(); MostrarEstadoPresu(); MostrarUsuarioPresu(); MostrarSucursalPresupuesto()">Nuevo </a>
                    <a id="btnModificar" class="btn btn-lg btn-info" style=" font-weight: bold" title="Modificar Factuta Compras" data-toggle="modal" onclick="recuperarDetallePresuCompra()">Recuperar </a>
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla de Presupuesto de Produccion</div>
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                                <input id="PresuNro" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de presupuesto Produccion">
                                <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                                <input id="estadoPresuC" type="text" style="" class="form-control" disabled="" placeholder="Estado de presupuesto produccion">
                        </div>
                    </div>
                    <div class="">
                            <div class="input-group input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Buscar</span>
                                <input id="filtrarPlanillaCompraPresu" type="text" style="text-transform: uppercase; font-weight: bold" 
                                       class="form-control " maxlength="20" onkeyup="buscadorPlanillaCompraPresu()"placeholder="Buscar Lista...">
                            </div>
                        </div>
                                ...
                                <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            <th class="alert-danger">CODIGO</th>
                                            <th class="alert-danger">FECHA</th>
                                            <th class="alert-danger">CLIENTES</th>
                                            <th class="alert-danger">USUARIO</th>
                                            <th class="alert-danger">TIPO</th>
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <a class="btn btn-lg btn-danger col-md-1"  id="btnGuardar" title="" onclick="InsertardetalleCompraPresu()" >Guardar</a>
                        <a class="btn btn-lg btn-danger col-md-1"  id="btnGuardarModificado" title="" onclick="ModificarDetallePedidoCo()" >Modificar</a>
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Presupuesto de Produccion</div>
                            <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="PresuCompProvee" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" autofocus=""
                                               type="text" placeholder="" class="form-control input-sm alert-danger" onclick="abrirproveedorPresu()">
                                    </div>
                                    
                                    <label class="col-md-1 control-label">PedidoProd</label>  
                                    <div class="col-md-3">
                                        <input id="PresuCompPedidoC" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-danger" 
                                               onkeyup="ValidacionesSoloNumeros()" onchange="ValidacionesSoloNumeros()" onclick="AbrirPedidoCompraPresu()"
                                               onkeydown="
                                                   if (event.keyCode === 13) {
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-1 control-label">P.Tipo</label>  
                                    <div class="col-md-2">
                                        <input id="PresuCompTipo" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-danger" onclick="AbrirtipoComprasPresu()">
                                    </div> 
                                    ...
                                    <div class="col-md-3">
                                        <input id="PresuCompMonto" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-danger"
                                               onkeyup="ValidacionesSoloNumeros()" onchange="ValidacionesSoloNumeros()">
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <input  id="PresuCompIdUsuario" type="text" style="visibility: hidden;">
                                    </div>
                                    <div class="col-md-2">
                                        <input id="PresuCompIdSucursal" style="visibility: hidden;" type="text">
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        <th style="display: none"></th>
                                            <th class="alert-danger">CODIGO</th>
                                            <th class="alert-danger">DESCRIPCION</th>
                                            <th class="alert-danger">PRECIO</th>
                                            <th class="alert-danger">CANTIDAD</th>
                                            <th class="alert-danger">SUB TOTAL</th>
                                            <th  class="alert-info" style="width: 30px"><div><center><img src="Recursos/img/delete.png"/></center></div></th>
                                    </tr>
                                </thead>
