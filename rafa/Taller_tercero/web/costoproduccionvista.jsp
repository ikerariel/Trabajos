<%-- 
    Document   : costoproduccionvista
    Created on : 05/08/2019, 09:56:33 AM
    Author     : Rafel
--%>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla Costo de Produccion</div>
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                                <input id="ordenNro" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de Costo">
                                <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                                <input id="estadOrdenP" type="text" style="" class="form-control" disabled="" placeholder="Estado de Costo">
                        </div>
                    </div>
                    <div class="">
                            <div class="input-group input-sm">
                                ...
                                <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            ...
                                            <th class="alert-info">COSTO</th>
                                            <th class="alert-info">USUARIO</th>
                                            <th class="alert-info">ORDEN</th>
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <a class="btn btn-lg btn-info col-md-1"  id="btnGuardar" title="" onclick="InsertarOrden()" >Guardar</a>
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Nuevo Costo de produccion</div>
                            <br> 
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-1 control-label">Maquinas</label>  
                                    <div class="col-md-2">
                                        <input disabled id="usuarioOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                                               type="text" placeholder="" class="form-control input-sm alert-info">
                                    </div>
                                    <label class="col-md-1 control-label">Trabajador</label>  
                                    <div class="col-md-3">
                                        <input id="proveeOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-info" onclick="abrirprov()">
                                    </div>
