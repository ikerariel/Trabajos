<%-- 
    Document   : ordenpedido_v
    Created on : 25/05/2018, 02:08:36 PM
    Author     : Carlos
--%>
...
<html>
    ...
    <head>
        ...
        <script src="Validadores/pedidocompravalidar.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesPedido">
                    ...
                    <a id="btnRecuperar" class="btn btn-lg btn-info" style=" font-weight: bold" title="Recuperar Orden de Compras" data-toggle="modal" onclick="recuperarDetallePedidoCompras()">Recuperar </a>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="">
                        ...
                        <div class="input-group  input-sm">
                            ...
                            <input id="v_obs" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Observaciones">
                        </div>
                    </div>
                    <div class="">
                        <div class="input-group input-sm">
                            <span class="input-group-addon" style=" font-weight: bold">Buscar</span>
                            <input id="filtrarPedido" type="text" style="text-transform: uppercase; font-weight: bold; background-color: #d9edf7" class="form-control " maxlength="20" onkeyup="buscadorTablaPedido()"placeholder="Buscar Pediod...">
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table input-md" id="miTablaPedidos" onclick="seleccion()">
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        <th class="alert-info">NRO. PEDIDO</th>
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <a class="btn btn-lg btn-info col-md-1"  id="btnGuardar" title="" onclick="InsertarPedidoCompra()" >Grabar*</a>
                        <a class="btn btn-lg btn-info col-md-1"  id="btnGuardarModificado" title="" onclick="EliminarDetalleMercaderia()" >Modificar</a>
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <br>
                            <div class="panel-footer" style="font-weight: bold">Nuevo Pedidos de Compras</div>
                            <br> 
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-md-1 control-label">Codigo</label>  
                                    <div class="col-md-2">
                                        <input  disabled="" id="codigo" style="font-weight: bold;font-size: 12pt" name="codigo" type="text" placeholder="Registro" class="form-control input-sm alert-info">
                                    </div>
                                      <label class="col-md-1 control-label">Fecha</label>  
                                    <div class="col-md-3">
                                        <input disabled id="fechapedido" type="datetime" style="font-weight: bold;font-size: 12pt"
                                               placeholder="Ingrese fecha" class="form-control input-sm alert-info">
                                    </div>
                                    <label class="col-md-1 control-label">Estado</label>  
                                    <div class="col-md-3">
                                        <input disabled id="estado"  type="text" style="font-weight: bold;font-size: 12pt" placeholder="PENDIENTE" value="PENDIENTE" class="form-control input-sm alert-info">
                                    </div>
                                </div>
                            </div>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input  id="usuario" style="font-weight: bold;font-size: 12pt" type="text" placeholder="Registro" class="form-control input-sm alert-info">
                                    </div>
                                    <label class="col-md-1 control-label">Obs.*</label>  
                                    <div class="col-md-7">
                                        <input maxlength="60" id="observ" style="font-weight: bold;font-size: 12pt" type="datetime"  class="form-control input-sm alert-info">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input disabled="" id="iddescripcion" type="text" placeholder="Descirpcion del producto"class="form-control input-sm alert-info" 
                                ...
                                <div class="col-md-2">
                                    <input disabled="" id="idpreci" type="text" placeholder="Precio" class="form-control input-sm alert-info" 
                                           style="font-weight: bold; background-color:#e6ffe6;font-size: 12pt"
                                           onkeyup="separadorMiles(this)" onchange="separadorMiles(this)">
                                </div>
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        <th style="display: none">cod</th>
                                            ...
                                            <th style="width: 30px" class="alert-info"><div><center><img src="Recursos/img/delete.png"/></center></div></th>
                                    </tr>
                                </thead>
                        ...
                        <div class="col-xs-3 col-xs-offset-9 input-group input-group-sm">
                            ...
                            <input class="form-control input-sm alert-info" id="total" style="font-size: 15px" type="text">
                        </div>
                    </div>
                </div>
            </div> 
