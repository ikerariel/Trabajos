<%-- 
    Document   : facturaventavista
    Created on : 31/07/2019, 11:20:16 AM
    Author     : Rafel
--%>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla de Factura Ventas</div>
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                                <input id="nrofacturaP" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de Ventas">
                                <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                                <input id="estadofacturaP" type="text" style="" class="form-control" disabled="" placeholder="Estado de Ventas">
                        </div>
                    </div>
                    <div class="">
                            <div class="input-group input-sm">
                                ...
                                <input id="filtrarPlanillaCompra" type="text" style="text-transform: uppercase; font-weight: bold" 
                                       class="form-control " maxlength="20" onkeyup="buscadorPlanillaCompra()"placeholder="Buscar Lista...">
                            </div>
                        </div>
                                ...
                                <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            ...
                                            <th class="alert-success">FACTURA NRO</th>
                                            <th class="alert-success">FECHA</th>
                                            <th class="alert-success">TIPO</th>
                                            <th class="alert-success">CLIENNTES</th>
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <a class="btn btn-lg btn-success col-md-1"  id="btnGuardar" title="" onclick="InsertarFacturaCompra()" >Guardar</a>
                        <a class="btn btn-lg btn-danger col-md-1"  id="btnGuardarModificado" title="" onclick="ModificarDetalleOrdenCo()" >Modificar</a>
                        <a class="close  btn btn-lg btn-success glyphicon glyphicon-off" data-dismiss="modal" aria-hidden="true" title="Salir"></a>
                    </div>
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Factura de Ventas</div>
                            <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input disabled="" id="codigo" style="text-transform: uppercase; font-weight: bold; font-size: 12pt" 
                                               name="codigo" type="text" placeholder="Codigo" class="form-control input-sm alert-success">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input disabled id="factuCompUsuario" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                                               type="text" placeholder="" class="form-control input-sm alert-success">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <input id="factuCompProvee" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" autofocus=""
                                               type="text" placeholder="" class="form-control input-sm alert-success" onclick="abrirproveedor()">
                                    </div>
                                    
                                    <label class="col-md-1 control-label">PediVenta</label>  
                                    <div class="col-md-3">
                                        <input id="factuCompOrdenC" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success" 
                                               onkeyup="ValidacionesSoloNumeros()" onchange="ValidacionesSoloNumeros()" onclick="AbrirOrdenCompra()"
                                               onkeydown="
                                                   if (event.keyCode === 13) {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input id="factuCompNroFactura" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success"
                                               onkeyup="ValidacionesSoloNumeros(this)" onchange="ValidacionesSoloNumeros(this)"onclick="abrirprov()">
                                    </div>
                                    <div class="col-md-1">
                                    ...
                                    <div class="col-md-2">
                                        <input id="facturatipoC" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success" onclick="tipoComprasAbrir()">
                                    </div>
                                    <div class="col-md-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input id="factuCompIntervalo" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                                               type="text" placeholder="Ingrese Intervalo" class="form-control input-sm alert-success"
                                               onkeyup="ValidacionesSoloNumeros(this)" onchange="ValidacionesSoloNumeros(this)"onkeydown="
                                    ...
                                    <div class="col-md-3">
                                        <input id="factuCompNroCuota" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="Ingrese Cuota" class="form-control input-sm alert-success"
                                    ...
                                    <div class="col-md-3">
                                        <input id="factuCompMonto" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="Ingrese Monto" class="form-control input-sm alert-success"
                                               onkeyup="ValidacionesSoloNumeros(this)" onchange="ValidacionesSoloNumeros(this)">
                                    </div>
                                </div>
                            </div>
