<%-- 
    Document   : notacreditodebitovista
    Created on : 01/07/2018, 03:30:10 PM
    Author     : Rafel
--%>
...
<html>
    ...
    <body>
        ...
        <div class="modal fade" id="ventanaNota">
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Nota de Credito y Debito</div>
                            <br> 
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-1">NotaTipo</label>
                                    <div class="col-md-3">
                                        <select class="form-control input-sm alert-danger" id="notatipo" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" >
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label" style="visibility: hidden">Proveedor</label>  
                                    <div class="col-md-2">
                                        <input id="notaProveedor" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;visibility: hidden" 
                                               type="text" placeholder="Ingrese Factura Compra" class="form-control input-sm alert-danger" onclick="abrirproveedorNota()">
                                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input class="form-control input-sm" id="nombreMerca" type="text" placeholder="Descirpcion del producto"
                                           style="text-transform: uppercase; font-weight: bold; background-color:#e6ffe6;font-size: 12pt"
                                           onkeyup="separadorMiles(this)" onchange="separadorMiles(this)">
                                </div>
                                <label class="col-md-1 control-label">Precio</label>
                                <div class="col-md-2">
                                    <input id="precioMerca" class="form-control input-sm" type="text" placeholder="Ingrese precio"
                                           style="text-transform: uppercase; font-weight: bold; background-color: #e6ffe6; font-size: 12pt"
                                ...
                                <table class="table table-striped table-bordered table-hover table input-md" id="miTablaDetalleNota" onclick="SeleccionarDetalleFacturaNota()">
                                    ...
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            ...
                                            <th class="alert-info" id="codigotablaNC">CODIGO</th>
                                            <th class="alert-info" id="descripcionablaNC">DESCRIPCION</th>
                                            <th class="alert-info" id="precioablaNC">PRECIO</th>
                                            <th class="alert-info" id="cantidadablaNC">CANTIDAD</th>
                                            <th class="alert-info" id="subtotalablaNC">SUB TOTAL</th>
        ...
        <div class="modal fade" id="ModalProveedorNota">
            <div class="modal-dialog" style="width: 400px;">
                <div class="modal-content">
                    ...
                    <DIV class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                <input id="filtrarProveedorNota" type="text" style="text-transform: uppercase; font-weight: bold" maxlength="20"
                                       class="form-control input-md" placeholder="Buscar Mercadeeria..." onkeyup="buscadorTablaProveeNota()">
                            </div>
                        </div>
                        <div class="panel-body">
                            <!-- Tabla detalle -->
