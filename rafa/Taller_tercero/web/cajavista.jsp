<%-- 
    Document   : cajavista
    Created on : 19/05/2019, 01:42:17 AM
    Author     : Rafel
--%>
...
<html>
    ...
    <head>
        ...
        <script src="Recursos/js/jquery.backstretch.min.js"></script>
        <script src="Validadores/cajvalidador.js"></script>
    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <label class="col-md-8 control-label" style=" font-weight: bold; font-size: 25pt; color: #003eff">GESTIONAR CAJAS</label> 
                <BR>
                <BR>
                <BR>
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold" >
                        <a id="btnNuevo" class="btn btn-lg btn-success" style=" display: none; font-weight: bold" onclick="autonumerico(), abilitarInsert()">Nuevo </a>
                        <a id="btnInsertar" class="btn btn-lg btn-primary" style=" display: none; font-weight: bold" onclick="controlarCampo(), campovacio()">Insertar </a>
                        ...
                        <a id="btnLimpiar" class="btn btn-lg btn-warning" style=" display: none; font-weight: bold" title="Limpiar" onclick="limpiarcampo()">limpiar</a>
                        <a id="btnReporte" class="btn btn-lg btn-primary glyphicon glyphicon-print" style=" display: none" title="Reportes" onclick="reportescaja()"></a>
                    </div>
                    <BR>
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input disabled="" id="cod_caja" style="font-weight: bold; font-size: 12pt; background-color: #d9edf7 " 
                                            type="text" placeholder="Registro" class="form-control input-sm" required=""
                                ...
                                <div class="col-md-4">
                                    <input id="descr_caja"  type="text" style=" font-weight: bold;font-size: 12pt; background-color: #d9edf7" 
                                           placeholder="Ingrese Nombres" onkeypress="return validarsololetras(event)" class="form-control input-sm" required autofocus="">
                                </div>
                            </div>
                        </div> 
                    </div> 
