<%-- 
    Document   : sectoresvista
    Created on : 14/11/2017, 05:28:08 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/sectoresvalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR SECTORES</div>
                    <br>
                    <div class="">
