<%-- 
    ...
    Created on : 13/11/2017, 11:00:20 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/estadovalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR ESTADO</div>
                    <br>
                    <div class="">
