<%-- 
    Document   : unimedivista
    Created on : 15/11/2017, 07:33:24 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/unimedivalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR UNIDAD DE MEDIDAS</div>
                    <br>
                    <div class="">
