<%-- 
    Document   : motivoajuvista
    Created on : 14/11/2017, 03:11:12 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/motivoajusvalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR MOTIVO AJUSTE</div>
                    <br>
                    <div class="">
