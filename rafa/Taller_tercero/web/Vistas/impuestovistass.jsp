<%-- 
    ...
    Created on : 14/11/2017, 12:21:16 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/impuestovalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR IMPUESTO</div>
                    <br>
                    <div class="">
