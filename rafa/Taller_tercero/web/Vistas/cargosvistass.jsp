<%-- 
    ...
    Created on : 12/11/2017, 11:29:08 AM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/cargosvalidador.js"></script>
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input  id="cod_cargos" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
                                ...
                                <div class="col-md-4">
                                    <input id="descr_cargos"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
