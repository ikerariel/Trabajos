<%-- 
    ...
    Created on : 09/05/2018, 07:16:44 PM
    Author     : Rafel
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/mercaderiavalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR MERCADERIAS</div>
                    <br>
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <input  id="cod_mercad" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
                                ...
                                <div class="col-md-3">
                                    <input id="mer_descri"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                                ...
                                <div class="col-md-2">
                                    <input id="costo"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt; 
                                ...
                                <div class="col-md-2">
                                    <input id="precio"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt; 
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-2" id="comboCategoria">
                                    <select id="idcate" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                                ...
                                <div class="col-md-2" id="comboMarcas">
                                    <select id="idmarc" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                                            background-color: #d9edf7" class="form-control input-sm"></select>
                                </div>
                                <label class="col-md-1 control-label" style=" font-weight: bold">PROCED.</label>  
                                <div class="col-md-2" id="comboProcedencia">
                                    <select id="idproceden" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                                            background-color: #d9edf7" class="form-control input-sm"></select>
                                </div>
                                <label class="col-md-1 control-label" style=" font-weight: bold">IMPUESTO.</label>  
                                <div class="col-md-2" id="comboImpuesto">
                                    <select id="idimpuest" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                                            background-color: #d9edf7" class="form-control input-sm"></select>
                                </div>
                            </div>
                        </div>
