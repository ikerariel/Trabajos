<%-- 
    Document   : procedenciasvista
    Created on : 13/11/2017, 06:54:56 PM
    Author     : naty
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../Validadores/procedenciasvalidador.js"></script>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">              
                    <div class="panel-footer" style="font-weight: bold">GESTIONAR PROCEDENCIAS</div>
                    <br>
                    <div class="">
