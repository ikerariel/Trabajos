<%-- 
    Document   : controldecalidadvista
    Created on : 04/08/2019, 10:55:19 PM
    Author     : Rafel
--%>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla Control de Calidad</div>
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                                <input id="ordenNro" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de Control calidad">
                                <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                                <input id="estadOrdenP" type="text" style="" class="form-control" disabled="" placeholder="Estado de Control validad">
                        </div>
                    </div>
                    <div class="">
                            <div class="input-group input-sm">
                                ...
                                <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            ...
                                            <th class="alert-warning">NOMBRE</th>
                                            <th class="alert-warning">USUARIO</th>
                                            <th class="alert-warning">ORDEN</th>
        ...
        <div class="modal fade" id="ventanaOrdenCompra">
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Nuevo Control de calidad</div>
                            <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input disabled="" id="codigo" style="text-transform: uppercase; font-weight: bold; font-size: 12pt" 
                                               name="codigo" type="text" placeholder="" class="form-control input-sm alert-warning">
                                    </div>
                                    <label class="col-md-1 control-label">Fecha</label>  
                                    <div class="col-md-3">
                                        <input disabled id="fechaOrden" type="datetime" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                                               placeholder="" class="form-control input-sm alert-warning">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input id="proveeOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-warning" onclick="abrirprov()">
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <input id="pedoidoOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="Ingrese Pedidos" class="form-control input-sm alert-warning" onclick="abrirpedi()"
                                               onkeydown="
                                                   if (event.keyCode === 13) {
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <input id="PrecioMer" disabled="" class="form-control input-sm" type="text" placeholder="Ingrese precio"
                                           style="text-transform: uppercase; font-weight: bold; background-color: #e6ffe6; font-size: 12pt"
