<%-- 
    Document   : estantesvista
    Created on : 22/05/2019, 02:22:06 PM
    Author     : Rafel
--%>
...
<html>
    ...
    <head>
        ...
        <script src="Recursos/js/jquery.backstretch.min.js"></script>
        <script src="Validadores/estantevalidador.js"></script>
    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <label class="col-md-8 control-label" style=" font-weight: bold; font-size: 25pt; color: #003eff">GESTIONAR ESTANTES</label> 
                <BR>
                <BR>
                <BR>
                <div class="panel panel-default"> 
                    <div class="panel-footer" style="font-weight: bold" >
                        <a id="btnNuevo" class="btn btn-lg btn-success" style=" font-weight: bold" onclick="autonumericoestante()">Nuevo </a>
                        <a id="btnInsertar" class="btn btn-lg btn-primary" style=" font-weight: bold" onclick="controlarCampoestan(), campovacioestan()">Insertar </a>
                        ...
                        <a id="btnLimpiar" class="btn btn-lg btn-warning" style=" font-weight: bold" title="Borrar" onclick="limpiarcampoestan()">limpiar</a>
                        <a id="btnReporte" class="btn btn-lg btn-primary glyphicon glyphicon-print" title="Reporte de Panilla" onclick="reportesEstante()"></a>
                    </div>
                    <BR>
                    <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input  id="codigo" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
                                        ...
                                        onkeydown=" if (event.keyCode === 13) { listarEstanteSegunFiltro(); }">
                                </div>
                                <label class="col-md-1 control-label" style=" font-weight: bold">NOMBRE</label>  
                                <div class="col-md-4">
                                    <input id="descr_est"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                    ...
                    <div class="table-responsive" > 
                        <div class="headercontainer" >
                            <div class="tablecontainer">
                                <table class=" table-striped table-bordered table-hover table input-md" id="miTabla" onclick="selecestan()">
                                    <thead>
                                        <tr>
                                            <th><div>CODIGO</div></th>
                                            <th><div>ESTANTE</div></th>
                                        </tr>
                                    </thead>
