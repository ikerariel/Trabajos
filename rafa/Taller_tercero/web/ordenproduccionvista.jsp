<%-- 
    Document   : ordenproduccionvista
    Created on : 04/08/2019, 06:50:33 PM
    Author     : Rafel
--%>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla Orden de Produccion</div>
                    <div class="">
                        <div class="input-group  input-sm">
                                <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                                <input id="ordenNro" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de Orden Produccion">
                                <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                                <input id="estadOrdenP" type="text" style="" class="form-control" disabled="" placeholder="Estado de Orden Produccion">
                        </div>
                    </div>
                    <div class="">
                            <div class="input-group input-sm">
                                ...
                                <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
                                        <tr class="alert-dismissable" >
                                            ...
                                            <th class="alert-success">PRODUCCION</th>
                                            <th class="alert-success">USUARIO</th>
                                            <th class="alert-success">PEDIDO</th>
        ...
        <div class="modal fade" id="ventanaOrdenCompra">
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <div class="panel-footer" style="font-weight: bold">Nueva Orden de Produccion</div>
                            <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input disabled="" id="codigo" style="text-transform: uppercase; font-weight: bold; font-size: 12pt" 
                                               name="codigo" type="text" placeholder="" class="form-control input-sm alert-success">
                                    </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label">F Inicio</label>  
                                    <div class="col-md-3">
                                        <input id="proveeOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success" onclick="abrirprov()">
                                    </div>
                                    
                                    <label class="col-md-1 control-label">F fin</label>  
                                    <div class="col-md-3">
                                        <input id="pedoidoOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success" onclick="abrirpedi()"
                                               onkeydown="
                                                   if (event.keyCode === 13) {
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label">M Prima</label>  
                                    <div class="col-md-3">
                                        <input id="proveeOrden" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="text" placeholder="" class="form-control input-sm alert-success" onclick="abrirprov()">
                                    </div>
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        <th style="display: none">cod</th>
                                            ...
                                            <th class="alert-success">MEDIDAS</th>
                                            <th class="alert-success">CANTIDAD</th>
                                            <th style="width: 30px" class="alert-danger"><div><center><img src="Recursos/img/delete.png"/></center></div></th>
                                    </tr>
                                </thead>
