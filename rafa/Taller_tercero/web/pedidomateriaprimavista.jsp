<%-- 
    Document   : pedidomateriaprimavista
    Created on : 01/08/2019, 03:58:47 PM
    Author     : Rafel
--%>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesPedido">
                    ...
                    <a id="btnRecuperar" class="btn btn-lg btn-info" style=" font-weight: bold" title="Recuperar Orden de Compras" data-toggle="modal" onclick="()">Recuperar </a>
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla: Pedidos de Materia Prima</div>

                    <div class="">
                        <div class="input-group  input-sm">
                            <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                            <input id="v_nropedido" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero materia prima">
                            <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                            <input id="v_estado" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Estado materia prima">
                        </div>
                        <div class="input-group  input-sm">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="scrollPlanilla" class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table input-sm" id="miTabl" onclick="seleccion()">
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <br>
                            <div class="panel-footer" style="font-weight: bold">Pedidos de Materia Prima</div>
                            <br> 
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-1 control-label">CmpPrenda</label>  
                                    <div class="col-md-7">
