<%-- 
    Document   : componenteprendavista
    Created on : 01/08/2019, 09:42:41 AM
    Author     : Rafel
--%>
...
<html>
    <head>
        ...
        <script src="Validador/pedidocompravalidar.js"></script>
         <title>Componente de Prendas</title>
    </head>
    <body>
        <section>
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="panel panel-default">
                    <div class="panel-footer" style="font-weight: bold">Planilla: Componente de Prendas</div>

                    <div class="">
                        <div class="input-group  input-sm">
                            <span class="input-group-addon" style=" font-weight: bold">Pedido Nro*</span>
                            <input id="v_nropedido" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Numero de componente">
                            <span class="input-group-addon" style=" font-weight: bold" >Estado*</span>
                            <input id="v_estado" type="text" style="background-color: #d9edf7" class="form-control" disabled="" placeholder="Estado de componente">
                        </div>
                        <div class="input-group  input-sm">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="scrollPlanilla" class="table-responsive">
                            <table class="table table-striped table-bordered table-hover table input-md" id="miTab" onclick="seleccion()">
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        ...
                                        <th class="alert-warning">PRODUCTO</th>
            ...
            <div class="modal-dialog" style="width: 1200px;">
                <div class="modal-content">
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            <br>
                            <div class="panel-footer" style="font-weight: bold">Componente de Prendas</div>
                            <br> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input  disabled="" id="codigo" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                                name="codigo" type="text" placeholder="Registro" class="form-control input-sm alert-warning" required=""  autofocus >
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <input disabled id="estado"  type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt"
                                               placeholder="PENDIENTE" value="PENDIENTE" class="form-control input-sm alert-warning">
                                    </div>
                                </div>
                            </div>
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input  id="usuario" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                                type="text" placeholder="Registro" class="form-control input-sm alert-warning" required="">
                                    </div>
                                    <label class="col-md-1 control-label">Productos</label>  
                                    <div class="col-md-3">
                                        <input maxlength="60" id="observ" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="" class="form-control input-sm alert-warning" required=""  autofocus onkeydown="">
                                    </div>
                                     <label class="col-md-1 control-label">TipoProductos</label>  
                                    <div class="col-md-3">
                                        <input maxlength="60" id="observ" style="text-transform: uppercase; font-weight: bold;font-size: 12pt" 
                                               type="" class="form-control input-sm alert-warning" required=""  autofocus onkeydown="">
                                    </div>
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <input id="idmaterialGenerico" type="text" placeholder="Cod" class="form-control input-sm alert-warning" onclick="abrir()"
                                ...
                                <div class="col-md-3">
                                    <input class="form-control input-sm alert-warning" disabled="" id="iddescripcion" type="text" placeholder="Descirpcion del producto"
                                ...
                                <div class="col-md-2">
                                    <input class="form-control input-sm alert-warning" disabled="" id="idpreci" type="text" placeholder="Medidas"
                                           style="text-transform: uppercase; font-weight: bold; background-color:#e6ffe6;font-size: 12pt"
                                           onkeyup="separadorMiles(this)" onchange="separadorMiles(this)">
                                </div>
                                ...
                                <div class="col-md-1">
                                    <input id="idcantidad" type="text" placeholder="Cant" maxlength="3" class="form-control input-sm alert-warning" 
                                           style="text-transform: uppercase; font-weight: bold; font-size: 12pt"
                                           onkeyup="separadorMiles(this)" onchange="separadorMiles(this)"
                                           onkeydown="
                                                   if (event.keyCode === 13) {
                                ...
                                <div class="col-md-1">
                                    <input disabled="" id="idmaterial" type="text" placeholder="" maxlength="3" class="form-control input-sm alert-warning" 
                                ...
                                <thead>
                                    <tr class="alert-dismissable" >
                                        <th style="display: none">cod</th>
                                            ...
                                            <th class="alert-warning">MEDIDAS</th>
