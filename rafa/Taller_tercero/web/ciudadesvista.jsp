<%-- 
    ...
    Created on : 22/05/2019, 02:00:01 PM
    Author     : Rafel
--%>
...
<html>
    ...
    <head>
        ...
        <script src="Recursos/js/jquery.backstretch.min.js"></script>
        <script src="Validadores/ciudadesvalidador.js"></script>
    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                <label class="col-md-8 control-label" style=" font-weight: bold; font-size: 25pt; color: #003eff">GESTIONAR CIUDADES</label> 
                <BR>
                <BR>
                <BR>
                <div class="panel panel-default"> 
                    <div class="panel-footer" style="font-weight: bold" >
                        <a id="btnNuevo" class="btn btn-lg btn-success" style=" display: none; font-weight: bold" onclick="autonumerico(); abilitarInsertCiu()">Nuevo </a>
                        <a id="btnInsertar" class="btn btn-lg btn-primary" style=" display: none; font-weight: bold" onclick="controlarCampociudad(), campovaciociudad()">Insertar </a>
                        ...
                        <a id="btnLimpiar" class="btn btn-lg btn-warning" style=" display: none; font-weight: bold" title="Borrar" onclick="limpiarcampociudad()">limpiar</a>
                        <a id="btnReporte" class="btn btn-lg btn-primary glyphicon glyphicon-print" style=" display: none" title="Reportes" onclick="reportesciud()"></a>
                    </div>
                    <BR>
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input disabled="" id="cod_ciudad" style="font-weight: bold; font-size: 12pt;
                                ...
                                <div class="col-md-4">
                                    <input disabled="" id="descr_ciudad"  type="text" style="font-weight: bold;font-size: 12pt;
                                           background-color: #d9edf7" placeholder="Ingrese nombre" onkeyup="Solotexto()" onchange="Solotexto()"
                    ...
                    <div class="table-responsive" > 
                        <div class="headercontainer" >
                            <div class="tablecontainer">
                                <table class=" table-striped table-bordered table-hover table input-md" id="miTabla" onclick="selecciudad()">
                                    <thead>
                                        <tr>
