...
public class NotaCreComprasdto {
    ...
    public NotaCreComprasdto(Integer id_compra,Integer cantidad_detcomp, Integer precio_detcomp, String articulo,Integer id_articulo, Integer id_deposito,Integer id_estado, Integer co_nrofact) {
        this.id_compra = id_compra;
