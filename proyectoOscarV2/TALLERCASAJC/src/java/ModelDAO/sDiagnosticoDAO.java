...
public interface sDiagnosticoDAO {
    ...
    boolean insertarDetalleDiagnostico(sDiagnosticoDTO dto, Integer dDiagnostico);
    ...
    String getdetalleDiagnostico(Integer codDiagnostico);

    Integer updatedetllaDiagnostico(Integer codDiagnostico);
