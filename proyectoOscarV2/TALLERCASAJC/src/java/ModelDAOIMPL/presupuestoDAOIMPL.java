        ...
        switch (v_caso) {
            case 1:
                try {
                    ...
                    sintaxiSql = " INSERT INTO presupuestocompra(id_estado,id_usuario,id_proveedor,id_deposito,idtipomoneda,id_pedidocompra)\n"
                            + "    VALUES (3,?,?,?,?,?);";
                    ...
                    preparedStatement.setObject(5, Dto.getId_pedidocompra());
            ...
            case 2:
                try {
                    ...
                    sintaxiSql = "UPDATE presupuestocompra\n"
                            ...
                            + "       id_deposito=?, idtipomoneda=?,id_pedidocompra=?\n"
                    ...
                    preparedStatement.setObject(4, Dto.getIdtipomoneda());
                    preparedStatement.setObject(5, Dto.getId_pedidocompra());
                    preparedStatement.setObject(6, Dto.getId_presucompra());
