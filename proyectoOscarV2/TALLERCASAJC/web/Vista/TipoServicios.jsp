    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input disabled="" type="" id="codtiposervicio" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
                ...
                <a id="btnInsertar" class="btn btn-lg btn-primary" style=" font-weight: bold" onclick="ControlarCampoTipoServicios(), campovacioTipoServicios()">Guardar </a>
