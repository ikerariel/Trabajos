    ...
    <body>
        ...
        <section>
            <form class="form-horizontal"  id="defaultForm">
                    ...
                    <div class="">
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input disabled="" type=""  id="codtipotarjeta" style="text-transform: uppercase; font-weight: bold; font-size: 12pt;
                                ...
                                <div class="col-md-4">
                                    <input id="tarjetipo" onkeypress="return validarsololetras(event)" type="text" style="text-transform: uppercase; font-weight: bold;font-size: 12pt;
                ...
                <a id="btnInsertar" class="btn btn-lg btn-primary" style=" font-weight: bold" onclick="ControlarCampoTiposTarjetas(), campovacioTiposTarjetas()">Guardar </a>
