            ...
            <form class="form-horizontal "  id="defaultForm">
                <div class="panel panel-footer" id="">
                    <div class="form-group">
                        <div class="col-md-6">
                            <a style=""  data-toggle="modal" href="#aperturacaja" title="Imprimir Factura"  id="btnNuevo" class="btn btn-lg btn-success" onclick="" ><span class="glyphicon glyphicon-check"></span> Nuevo</a>
                            <a   data-toggle="modal" title="Cerrar Caja"   id="btnNuevo" class="btn btn-lg btn-danger" onclick="cerrarCaja()" ><span class="glyphicon glyphicon-chevron-down"></span> Cierre</a>
                            <a  href="" data-toggle="modal" title="Vista Previa"  id="btnver" class="btn btn-lg btn-primary" onclick="reportefacturado()" ><span class="glyphicon glyphicon-print"></span> Facturacion</a>
                            <a  href="" data-toggle="modal" title="Vista Previa"  id="btnver" class="btn btn-lg btn-primary" onclick="reportearqueo()" ><span class="glyphicon glyphicon-print"></span> Arqueo</a>
                        </div>
