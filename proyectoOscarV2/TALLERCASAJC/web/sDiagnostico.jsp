            ...
            <form class="form-horizontal"  id="defaultForm">
                ...
                <div class="col-md-9" id="botonesRecepcion">
                    <a id="btnNuevoDiagnostico"  class="btn btn-lg btn-success" style=" font-weight: bold"   data-toggle="modal"
                       >Nuevo </a>
                    <a id="btnConfirmarDiagnostico" class="btn btn-lg btn-warning glyphicon glyphicon-ok"  style=" font-weight: bold" title="Confirmar Diagnostico"></a>
                    <a id="btnRevertirDiagnostico" class="btn btn-lg btn-danger glyphicon glyphicon-minus-sign" style=" font-weight: bold" title="Revertir Diagnostico" ></a>
                    <a id="btnInformeDiagnostico" class="btn btn-lg btn-primary glyphicon glyphicon-print" style=" font-weight: bold" title="Ver Informe" onclick=""></a>
                </div>
                    ...
                    <div class="panel">
                        <div class="panel panel-default">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-2  control-label">Nro. Recepción</label>  
                                    <div class="col-md-1">
                                        <input list="lisrecepc" id="nrorecpecionDiagnostico" type="text" style="font-weight: bold;font-size: 12pt"
                                               class="form-control input-sm "
                                                   onkeydown="
                                       if (event.keyCode === 13) {
                                       recuperarRecepcionDiagnostico(); 
                                       }">
                                         <datalist id="lisrecepc">
                                    </datalist>
                                    </div>
                                    <label class="col-md-2  control-label">Fecha Recepción</label>  
                                    <div class="col-md-2">
                                        <input disabled="" id="fecharecpe" type="text" style="font-weight: bold;font-size: 12pt"
                                               class="form-control input-sm ">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <textarea id="obsDiagnostico" maxlength="200" style="font-weight: bold; font-size: 12pt" 
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <input list="listaarticulosD"  name="lisart "id="v_articusD" type="text" 
                                           placeholder="Cod" class="form-control"
                                           onkeydown="
                                       if (event.keyCode === 13) {
                                          traerArti();
                                       }">
                                    <datalist id="listaarticulosD">
                                    </datalist>
                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive" style="height: 180px">
                                <table  class="table table-striped table-bordered table-hover table input-md" id="mitabladetallediagnostico">
                                    <!--<table class="table table-hover  table-condensed with-pager input-md" id="miTabla" onclick="seleccion()">-->
                                    <thead>
