                ...
                <div class="panel panel-default"> 
                    <div class="col-md-3">
                      ...
                      <div class="panel-footer" style="font-weight: bold; text-align: center" >
                          <label class="control-label">Libro Venta <span class="">  <input id="vlibroventa" style="width: 25px; height: 25px" type="checkbox"></span></label> 
                      </div>
                      <div class="panel-footer" style="font-weight: bold; text-align: center; display: none" >
