...
function viewFechas() {
    ...
    $('#fechaDiagnostico').val(fv.getDate() + "/" + (fv.getMonth() + 1) + "/" + fv.getFullYear());
    $('#fechaPServicio').val(fv.getDate() + "/" + (fv.getMonth() + 1) + "/" + fv.getFullYear());
    $('#fechaOrdentrabajo').val(fv.getDate() + "/" + (fv.getMonth() + 1) + "/" + fv.getFullYear());
    $('#fechaEQ').val(fv.getDate() + "/" + (fv.getMonth() + 1) + "/" + fv.getFullYear());
}
